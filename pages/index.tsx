  ...
  return (
    <div className="flex flex-col space-y-10 bg-gradient-to-b from-slate-800 via-bgpink to-bgdark min-h-screen text-white justify-center items-center">
      <Head>
        ...
        <meta
          name="description"
          content="SyncPen is an online community for testing and showcasing user-created HTML, CSS and JavaScript code snippets. It functions as an online code editor and open-source learning environment, where developers can create code snippets, "
        />
      ...
      <footer className="fixed bottom-2">
        ...
        <a
          ...
          href="https://github.com/krtk-097"
        >
          {" "}
          Kartik Sharma
        </a>
